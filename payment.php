...
<input type="checkbox" id="check">
    ...
    <div class="sidebar">
      ...
      <a href="uservote.php"><i class="fas fa-vote-yea"></i><span>Vote Machine</span></a>
                ...
                <div class= "paycontainer">
                    ...
                    <form action="#" method="POST">
                        <div class="payform">
                            ...
                            <input type="number" class="field" name="pamount" placeholder="$ Enter Your Amount" min="0" required><br>
